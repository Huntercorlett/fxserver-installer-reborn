...
export const commandDefinitions: CommandDefinition[] = [
	...
	{ id: "open-website-hosting", title: "Website Hosting", description: "Serve website folders on a port of your choice.", category: "Tools", page: "website", keywords: ["website", "web", "http", "host", "port", "html", "static"] },
